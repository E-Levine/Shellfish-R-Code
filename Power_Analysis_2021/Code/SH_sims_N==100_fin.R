...
SH <- read.csv("spatSH.csv", na.strings = c("-999"))
...
# This is just a counter to keep track of progress; change 100 to something else (e.g. 100) if you want more regular updates        
...
###################################################################
### NOW DO THE SAME THING BUT DO IT BY YEAR AND QUARTER N ==100 ###
###################################################################
